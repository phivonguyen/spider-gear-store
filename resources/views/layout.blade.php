...
<html lang="en" dir="ltr">
    ...
    <body class="bg-light">
                            ...
                            <div class="main-menu-block">
                                <div class="menu-left">
                                    ...
                                    <div class="brand-logo logo-sm-center">
                                        <a href="index.html">
                                            <img
                                                src="../assets/images/layout-5/logo/logo.png"
                                                class="img-fluid"
                                                alt="logo-header"
                                            />
                                        </a>
                                                        ...
                                                        <div class="container">
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    <div>
                                                                        <img
                                                                            src="../assets/images/layout-5/menu-banner/1.jpg"
                                                                            alt="menu-banner"
                                                                            class="img-fluid"
                                                                        />
                                                                    </div>
                                                                ...
                                                                >
                                                                    <div>
                                                                        <img
                                                                            src="../assets/images/layout-5/menu-banner/2.jpg"
                                                                            alt="menu-banner"
                                                                            class="img-fluid"
                                                                        />
                                                                    </div>
                                                        ...
                                                        <div class="container">
                                                            <div class="row">
                                                                ...
                                                                >
                                                                    ...
                                                                    >
                                                                        <img
                                                                            src="../assets/images/layout-5/menu-banner/3.jpg"
                                                                            alt="menu-banner"
                                                                            class="img-fluid"
                                                                        />
                                                                    </div>
                                ...
                                <div class="menu-right">
                                    <div class="icon-nav icon-block">
                                        <ul>
                                            ...
                                            <li
                                                class="cart-block mobile-cart item-count"
                                                onclick="openCart()"
                                            >
                                                <a href="javascript:void(0)">
                                                    <svg
                                    ...
                                    <div class="nav-block">
                                        <div class="nav-left">
                                            ...
                                            >
                                                ...
                                                <h5
                                                    class="mb-0 ms-3 text-white title-font"
                                                >
                                                    Shop by category
                                                </h5>
                                            </nav>
                                            <div
                                                class="collapse hide nav-desk"
        ...
        <!-- subscribe start -->
        <section class="subscribe1 newsletter-inverse">
            <img
