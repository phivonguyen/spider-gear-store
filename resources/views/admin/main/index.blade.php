                                ...
                                <div class="card btn-months">
                                    <div class="card-header">
                                        ...
                                        <div class="dashboard-btn-groups">
                                            ...
                                            >
                                                <button
                                                    class="btn btn-outline-light btn-js"
                                                    type="button"
                                                >
                                                    Day
                                                </button>
                                                ...
                                                <button
                                                    class="btn btn-outline-light btn-js active"
                                                    type="button"
                                                >
                                                    Month
                                                </button>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="code-box-copy">
                                            <button
                                                class="code-box-copy__btn btn-clipboard"
                                                data-clipboard-target="#example-head8"
                                                title=""
                                                data-original-title="Copy"
                                            >
                                                <i
                                            ...
                                            <pre
                                                class="language-html"
                                            ><code class=" language-html" id="example-head8">
&lt;div class="revenue-chart"&gt;&lt;/div&gt;
                                    </code></pre>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div class="chart-value-box pull-right">
                                            <div
                                                class="value-square-box-success"
                                            ></div>
                                            <span class="f-12 f-w-600"
                                                >Physical</span
                                            >
                                            <div
                                                class="value-square-box-secondary ms-3"
                                            ></div>
                                            <span class="f-12 f-w-600"
                                                >Digital</span
                                            >
                                ...
                                <div class="card btn-months">
                                    <div class="card-header">
                                        ...
                                        <div class="dashboard-btn-groups">
                                            ...
                                            >
                                                <button
                                                    class="btn btn-outline-light btn-js1"
                                                    type="button"
                                                >
                                                    Day
                                                </button>
                                                ...
                                                <button
                                                    class="btn btn-outline-light btn-js1 active"
                                                    type="button"
                                                >
                                                    Month
                                                </button>
                            ...
                            <div class="col-xl-4 xl-50">
                                <div class="card customers-card">
                                    <div class="card-header">
                                        ...
                                        <div class="chart-value-box pull-right">
                                            <div
                                                class="value-square-box-secondary"
                                            ></div>
                                            <span class="f-12 f-w-600"
                                                >Customers</span
                                            >
                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        <div class="code-box-copy">
                                            <button
                                                class="code-box-copy__btn btn-clipboard"
                                                data-clipboard-target="#example-head7"
                                                title=""
                                                data-original-title="Copy"
                                            >
                                                <i
                                            ...
                                            <pre
                                                class="language-html"
                                            ><code class=" language-html" id="example-head7">
&lt;div id="customers"&gt;&lt;/div&gt;
                                    </code></pre>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-xl-8">
                                                <div
                                                    class="jvector-map-height"
                                                    id="world"
                                                ></div>
                                            </div>
                                            <div class="col-xl-4">
                                                <div
                                                    class="table-responsive map-table"
                                                >
                                        ...
                                        <div class="code-box-copy">
                                            <button
                                                class="code-box-copy__btn btn-clipboard"
                                                data-clipboard-target="#example-hea6"
                                                title=""
                                                data-original-title="Copy"
                                            >
                                                <i
                                            ...
                                            <pre
                                                class="language-html"
                                            ><code class=" language-html" id="example-head6">
&lt;div class="row"&gt;
    &lt;div class="col-xl-8"&gt;
