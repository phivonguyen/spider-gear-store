@extends('layout') @section('title', 'Home') @section('body')
<!--slider start-->
                        ...
                        <div class="slider-banner slide-banner-4">
                            <div class="slider-img">
                                <ul class="layout5-slide-1">
                                    <li id="img-1">
                                        <img
                                            src="../assets/images/layout-5/slider/1.1.png"
                                            class="img-fluid"
                                            alt="slider"
                                        />
                                    </li>
                        ...
                        <div class="product-box">
                            <div class="product-imgbox">
                                ...
                                <div class="product-back">
                                    <a href="product-page(left-sidebar).html">
                                        <img
                                            src="../assets/images/layout-5/product/7.jpg"
                                            class="img-fluid"
                                            alt="product"
                                        />
                                    </a>
                            ...
                            <div class="product-detail detail-inline">
                                <div class="detail-title">
                                    ...
                                    <div class="detail-right">
                                        <div class="check-price">$ 81.21</div>
                                        <div class="price">
                                            <div class="price">$ 75.05</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="row collection2">
            <div class="col-md-4">
                <div class="collection-banner-main p-right banner-9">
                    <div class="collection-img">
                        <img
                            src="../assets/images/layout-5/collection-banner/1.jpg"
            ...
            <div class="col-md-4">
                <div class="collection-banner-main p-right banner-9">
                    <div class="collection-img">
                        <img
                            src="../assets/images/layout-5/collection-banner/2.jpg"
                            class="img-fluid bg-img"
                            alt="banner"
                        />
                    </div>
            ...
            <div class="col-md-4">
                <div class="collection-banner-main p-right banner-9">
                    <div class="collection-img">
                        <img
                            src="../assets/images/layout-5/collection-banner/3.jpg"
                            class="img-fluid bg-img"
                            alt="banner"
                        />
                    </div>
                                    ...
                                    <div class="product-box">
                                        <div class="product-imgbox">
                                            <div class="product-front">
                                                ...
                                                >
                                                    <img
                                                        src="../assets/images/layout-5/product/8.jpg"
                                                        class="img-fluid"
                                                        alt="product"
                                                    />
                                                </a>
                                            ...
                                            <div class="product-back">
                                                ...
                                                >
                                                    <img
                                                        src="../assets/images/layout-5/product/4.jpg"
                                                        class="img-fluid"
                                                        alt="product"
                                                    />
                                                </a>
                                    ...
                                    <div class="product-box">
                                        <div class="product-imgbox">
                                            <div class="product-front">
                                                ...
                                                >
                                                    <img
                                                        src="../assets/images/layout-5/product/6.jpg"
                                                        class="img-fluid"
                                                        alt="product"
                                                    />
                                                </a>
                                            ...
                                            <div class="product-back">
                                                ...
                                                >
                                                    <img
                                                        src="../assets/images/layout-5/product/12.jpg"
                                                        class="img-fluid"
                                                        alt="product"
                                                    />
                                                </a>
                        ...
                        <div class="blog-contain">
                            ...
                            <div class="blog-details">
                                ...
                                <p>
                                    ...
                                    adipiscing elit. Curabitur eleifend a massa
                                    rhoncus gravida.
                                </p>
                                <span
