@extends('layout') @section('title', 'Product Detail') @section('body')
<!-- breadcrumb start -->
        ...
        <div class="custom-container">
            <div class="row">
                <div class="col-sm-3 collection-filter">
                    <div
                        class="collection-filter-block creative-card creative-inner"
                    >
                ...
                <div class="col-lg-9 col-sm-12 col-xs-12">
                    ...
                    <section
                        class="tab-product tab-exes creative-card creative-inner"
                    >
                        <div class="row">
